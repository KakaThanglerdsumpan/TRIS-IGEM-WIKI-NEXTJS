    ...
    <div>
      ...
      <div class="body1">
        ...
        <p class="indented1">
          ...
          bumblebee
          <i> Bombus ignitus</i> to pGEX-61 by process of DNA synthesis. From
          this, we found out that bombolitin has a 2kDa mature peptide with
          approximately 18-amino acid residues. Since we were concerned with the
          stability and activity of the peptide, we decided to modify the
          peptide by adding 3 amino acids which were phenylalanine, leucine, and
          tryptophan at the C-terminal to test the stability and activity. We
        ...
        <p class="indented1">
          ...
          that the rBombolitin 22.04 kDa bound to the Ni-NTA column was eluded
          by 300mM imidazole. We also tested using agar diffusion assay and the
          result showed that 500 µg of the modified Bombolitin peptide displayed
        ...
        <p class="indented1">
          ...
          inhibition of 10mm. We have concluded that the minimum inhibitory
        ...
        <p class="indented1">
          ...
          of 10 mL, and finally spread. For the second round of biopanning, the
