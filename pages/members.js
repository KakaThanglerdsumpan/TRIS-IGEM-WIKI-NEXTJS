...
function MembersPage({ children }) {
  return (
    <div>
        ...
        <div class = "body">
            <Image src = "https://static.igem.wiki/teams/4314/wiki/tmp.png" width= {700} height={450}/>
        ...
        <div class = "row">
          <div class = "member-column">
            ...
            <div class = "row">
              <Image src = "https://static.igem.wiki/teams/4314/wiki/tmp.png" width= {350} height= {225} />
            </div>
          </div>
        </div>
