         ...
         <div class = "sizedbox20"></div>
          <p class = "indented1"> 
            ...
            <div class = "center-horizontal">
                            <img src = "https://static.igem.wiki/teams/4314/wiki/engineering-design.png" class = "fitimage1"/>  
          ...
          Although we weren't able to express all three modifications of bombolitin, we registered all three as Parts on the Parts Registry Page for other teams to use in the future. The fact that the other two modifications were not able to be expressed could be due to multiple reasons, such as mistakes with the protocol such as annealing the primers at the wrong temperature or using competent cells there were too old during heatshock transformation or electroporation. Furthermore, we also learned about the crucial role of thioredoxin in producing the modified bombolitin since it prevents the competent cells from destroying themselves after producing the modified bombolitin.
            ...
            <div class = "sizedbox20"></div>
          <p class = "indented1"> 
          Ligation is a crucial step in Group 1&#39;s work, as it is the segment where the recombinant plasmid is created. The process of ligation requires a vector, an insert, T4 ligase buffer, T4 ligase, and molecular water. Once these have been acquired and mixed together, it is to be incubated for 16 hours at 16°C overnight. In this case, the vector is the pET-32a, and the insert is the modified bombolitin.             </p>
<div class = "sizedbox20"></div>
         ...
         <div class = "sizedbox20"/>
            ...
            <div class = "sizedbox20"></div>
          <p class = "indented1"> 
          We believe that we did not get the expected band size because the vector to insert ratio was too high. Due to this, the ratio of the vector to insert was changed to 1:2, where we used 4µL of the vector with 8µL of the insert and 3µL of the vector with 6µL of the insert. With this new ratio, we were able to get the expected band size because we decreased the vector, while keeping the insert the same.            </p>
            <div class = "sizedbox20"></div>
...
<div class = "sizedbox20"></div>
            ...
            <div class = "sizedbox20"></div>
          <p class = "indented1"> 
          In order to determine which nanobody binds best with <i>R.solanacearum</i> bacteria to combat bacterial wilt, biopanning must be performed twice. <i>R.solanacearum</i> will be prepared as a bacteria chain in the form of 96 well plates using a coating buffer that was previously prepared to infect <i>E. coli.</i> The Phosphate-buffered saline solution that will be used contains 0.05% Tween-20, which is less toxic than the alternative, tween-80 and a better fit for the experimental procedures. After determining the values of the antibodies, 20 random colonies will be selected to test for binding capacity through Indirect Enzyme-Linked Immunosorbent Assay (ELISA).         </p>

            <div class = "sizedbox20"/>
            <div class = "center-horizontal">
                            <img src = "https://static.igem.wiki/teams/4314/wiki/screen-shot-2565-10-12-at-04-06-42.png" class = "fitimage1"/>
            ...
            <div class = "sizedbox20"></div>
          <p class = "indented1"> 
          Biopanning will be completed by immobilizing each prepared bacteria chain onto a well plate with coating buffer. This will be incubated at 37 degrees celsius overnight. The first round of Biopanning will use TG1 <i>E. coli</i>, as it is a suppressor host strain that stops protein synthesis when a stop codon is detected. After that, the detected protein strain will undergo biopanning again, however, this time, using HB2151 <i>E. coli</i> to read the proteins’ codons. 

</p>
         <div class = "sizedbox20"/>
         <p class = "indented1"> 
         Afterwards, 20 colonies (E.coli HB2151) will be randomly selected to determine binding capacity to <i>R.solanacearum</i> by indirect ELISA. Finally, the binding capacity will be determined through a color indicator where the wells containing the nanobodies will change from blue to yellow. 
</p>
         <div class = "sizedbox20"/>
            ...
            <div class = "sizedbox20"></div>
          <p class = "indented1"> 
          From the experiment, the members of the Group 2 Lab learned methods of biopanning and indirect ELISA as well as the multiple trials needed when completing a research lab. Most importantly, they were able to determine the nanobody that binds with <i>R.solanacearum</i> from the experiment.            
</p>           
