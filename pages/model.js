...
<div class = "sizedbox20"></div>
            ...
            <div class = "sizedbox20"></div>
          <p class = "indented1"> 
          The bombolitin antimicrobial peptide is already established to be an antimicrobial peptide that has the ability to penetrate cell membranes and cause cell lysis.
Our project aims to modify the structure of the bombolitin through the addition of three amino acids in order to increase the peptide&#39;s hydrophobicity and ability to penetrate the <i>Ralstonia Solanacearum</i> cell membranes.
There are various possibilities in which the three additional amino acids can be ordered. Although it is possible to express and perform in-vitro testing for all the combinations, it is much easier to check the most likely combinations through modeling and molecular docking.
         </p>
         ...
         <div class = "sizedbox20"/>
            ...
            <div class = "center-horizontal">
                            <img src = "https://static.igem.wiki/teams/4314/wiki/screen-shot-2565-10-12-at-03-15-11.png" class = "fitimage1"/>
                            <p class = "fitimage1">Bombolitin with LLL Modification Structure Prediction</p>  
