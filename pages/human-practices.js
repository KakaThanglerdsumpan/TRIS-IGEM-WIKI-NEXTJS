      ...
      <div>
        ...
        <div class = "sizedbox60"/>
          ...
          <div class = "myheader">
            ...
            <div class = "sizedbox20"/>
            <p class = "indented1"> 
                        From this interview, Dr. Pimsiri shared her knowledge about the impacts of Ralstonia on solanaceous crops. 
                        </p>
            <div class = "sizedbox20"/>
            <p class = "indented1"> 
                        What can we do with what we are given? How can we help better the environment? Who are some people that we can affect positively with our project? Answering these questions enables us to enhance and further our vision, striving towards a more fulfilling end goal. This has led us to different interactions with various people from diverse backgrounds, in hopes of finding a way to increase the effect that our project might have on the world. With each coming interaction, we gain more knowledge that is incorporated into our project.
            ...
            <div class = "sizedbox20"/>
            <p class = "indented1"> 
                We surveyed a total of 15 consumers at the supermarket. All of which had answered that their main priority when buying fruits and vegetables is the quality of the produce-this includes the use of pesticides. However, one main factor that influences the choice is income. If the economy is good, the consumer would choose organic products which are generally more expensive. However, if the economy is bad, the consumer would try to choose products that are cheaper on the price range but be more observant with the produce.
            </p>
