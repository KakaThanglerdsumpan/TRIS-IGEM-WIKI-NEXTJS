      ...
      <div>
        ...
        <div class = "sizedbox60"/>
          ...
          <div class = "myheader">
            ...
            <p class = "indented1"> 
            One of the core segments that iGEM wishes teams to work upon requires us to reflect on multiple standards, with the most important idea being “how does your work affect the world, and how the world affects your work.”                        </p>
            <div class = "sizedbox20"/>
            <p class = "indented1"> 
            ...
            <div class = "sizedbox20"/>
            <p> 
                Dr. Karsidete → Dr. Theerapat → Dr. Pimsiri → Por Kasem → Ms. Kate Bhasamol → Mr. Yutthana → Survey at Sammakorn → Google form survey                </p>
            <div class = "sizedbox20"/>
            ...
            <div class = "sizedbox20"/>
            <p class = "indented1"> 
            The first professor that we interviewed was Dr. Theerapat Luangsuphabool and his team from theBiotechnology Research and Development Office, Department of Agriculture. From this interview, we were able to gain incredibly insightful feedback about our project and the things that we should consider when making the antimicrobial peptides an actual product. He brought up the fact that proteins need specific conditions to work, so we need to be careful about the conditions that the peptide will be used in, since it could denature at high temperatures. Considering Thailand’s warm climate, this perspective was very beneficial. <b>From this feedback, we were able to brainstorm the idea of applying the antimicrobial peptide on the crops exclusively at night, eliminating the possibility of denaturation.</b> Additionally, he also brought up the topic of shelf life and the potential side effects of the antimicrobial peptide on the consumers. At this point in time, we are not able to answer that question yet, as more research had to be done before it became a full fledged product.                        </p>
            <div class = "sizedbox20"/>
            <div class = "center-horizontal">
                            <img src = "https://static.igem.wiki/teams/4314/wiki/hp.png" class = "fitimage1"/>    
                        </div>
            <div class = "sizedbox20"/>
            ...
            <div class = "sizedbox20"/>
            <p class = "indented1"> 
            <b>The interview that we conducted with Dr. Pimsiri, enabled us to learn that it is better to have multiple techniques working together to solve the problem, rather than a single technique, in order to ensure the best results.</b>
                        </p>
                        <div class = "sizedbox20"/>
            <div class = "sizedbox20"/>
            <p class = "indented1"> 
            From this interview, Dr. Pimsiri shared her knowledge about the impacts of <i>Ralstonia</i> on solanaceous crops. She informed us on how <i>Ralstonia</i> is able to easily spread from one plant to another. In fact, the bacteria can spread simply by using the same scissors that were used to cut infected plants to cut uninfected plants. It can even spread through water irrigation systems. In order to combat this, she suggested that we use a combination of various solutions. <b>Along with our initial antimicrobial peptide, we could use non-uv plastic to cover up the crops, helping to prevent the growth of bacteria through heat, while also utilizing crop rotation</b>, the process of growing crops from separate families in different seasons.

</p>
            <div class = "sizedbox20"/>
            <p class = "indented1"> 

            This allows us to prevent <i>Ralstonia</i> from having control over the solanaceous crops, as <i>Ralstonia</i> is able to live in the soil for a long time, even after the crops die. With all of these techniques working in conjunction, we believe that it will achieve the optimum results.                        </p>
            <div class = "sizedbox20"/>
          
            <div class = "center-horizontal">
                            <img src = "https://static.igem.wiki/teams/4314/wiki/hp2.png" class = "fitimage1"/>    
                        </div>
            <div class = "sizedbox20"/>
            ...
            <div class = "sizedbox20"/>
            <div class = "center-horizontal">
                            <img src = "https://static.igem.wiki/teams/4314/wiki/hp7.png" class = "fitimage1"/>    
                        </div>
            <div class = "sizedbox20"/>
            <p class = "indented1"> 
            ...
            <div class = "sizedbox20"/>
            <div class = "center-horizontal">
                            <img src = "https://static.igem.wiki/teams/4314/wiki/hp8.png" class = "fitimage1"/>    
                        </div>
            <div class = "sizedbox20"/>
            <div class = "center-horizontal">
                            <img src = "https://static.igem.wiki/teams/4314/wiki/hp9.png" class = "fitimage1"/>    
                        </div>
            <div class = "sizedbox20"/>
            <p class = "indented1"> 
            ...
            <div class = "sizedbox20"/>
            <div class = "center-horizontal">
                            <img src = "https://static.igem.wiki/teams/4314/wiki/hp10.png" class = "fitimage1"/>    
                        </div>
            <div class = "sizedbox20"/>
            <p class = "indented1"> 
            Worryingly, only ~55% of the respondents would prefer a synthetic pesticide over chemical pesticides, meaning almost half of them are unsure about the use of synthetic biology. Even though most of the people doing this google form are aware of the negative effects of pesticides, nearly half of those people are still doubting synthetic biology. <b>From this, we have realized that what Mr. Yutthana said was true, and educating people about synthetic biology should be one of the main goals of our project.</b>
                        </p>
            <div class = "sizedbox20"/>
            <div class = "center-horizontal">
                            <img src = "https://static.igem.wiki/teams/4314/wiki/hp11.png" class = "fitimage1"/>    
                        </div>
            <div class = "sizedbox20"/>
            <p class = "indented1"> 
            A total of 435 out of 511 people said that they do think finding an alternative to pesticides is of utmost importance, which makes up a total of 85.1%. Although there is still a small number of people who do not think that an alternative to pesticides is important, the majority of the people do. Relating back to the previous question, this means that people do care about finding an alternative to pesticides, but half of them do not think that synthetic biology is the answer. <b>This demonstrates the need to change the negative stigma against synthetic biology in Thailand.</b>
                        </p>
            <div class = "sizedbox20"/>
            <div class = "center-horizontal">
                            <img src = "https://static.igem.wiki/teams/4314/wiki/hp12.png" class = "fitimage1"/>    
                        </div>
            <div class = "sizedbox20"/>
            <p class = "indented1"> 
            Lastly, when people were asked whether or not the price of crops affected their decision of choosing pesticides or not, 86.3% of the people said that they would rather pay more in order to buy a product that has not been exposed to pesticides.<b>This was the same information that we received from our local survey at Sammakorn, so we are able to conclude that price is not a problem for people in Thailand, as long as they are able to gain access to an option safer than pesticides.</b>

</p>
            <div class = "sizedbox20"/>
            <div class = "center-horizontal">
                            <img src = "https://static.igem.wiki/teams/4314/wiki/hp13.png" class = "fitimage1"/>    
                        </div>
            <div class = "sizedbox60"/>
            <div class = "myheader">
                            <div class = "white-rounded-container">
