      ...
      <div class="body">
        <p class="indented">
          <b>
            ...
            resulting in increased efficiency. The modified bombolitin
            antimicrobial peptide will ultimately be the main composition of a
        ...
        <p class="indented">
          ...
          modified bombolitin antimicrobial peptide can be used in the form of a
          spray that will be applied into the soil since <i>Ralstonia</i> is a
          soil-borne pathogen. This way, the modified bombolitin antimicrobial
          peptide will kill the <i>Ralstonia</i> that is infecting the plants at
          its roots. The modified bombolitin antimicrobial peptide will be
          attracted to the gram negative cell membrane of <i>Ralstonia</i>,
          promptly disrupt the membrane structure, and ultimately cause cell
          lysis.
        </p>
        <div class="sizedbox60" />
        {/* HEADER */}
        ...
        <p class="indented">
          ...
          that need to be addressed. In order for the product to be effective,
          the peptide cannot denature. In response, heat shock proteins such as
          Hsp 60 can potentially prevent the denaturation of the peptide.
          Additionally, specified use of time for the ideal temperature will
        ...
        <p class="indented">
          ...
          temperature, peptides could degrade within 24 hours, and -20°C is
          preferred for long term storage. However, -20°C might not be practical
        ...
        <p class="indented">
          ...
          skeptical of a genetically modified product which would significantly
          lower the demand. This may be solved through educating local farmers
          about genetically modified products and the effectiveness of said
          product. Additionally, the costs of production and the selling price
          of the product has to be determined. As we know, because of the way
          the product is being produced, through synthetic biology, the initial
          cost of the production would be high. Due to this, we would have to
