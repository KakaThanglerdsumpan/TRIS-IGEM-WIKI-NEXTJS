...
import MemberStuffS from '../components/memberStuffsmall'
        ...
        <div>
            <div className="members-wide">
                <div className="titleScreen1">
                    <h1 className="titlescreentext text-3xl">MEMBERS</h1>
                </div>
                ...
                <div className="row">
                    <div className="rounded-container1">
                        <h1 className="header1 text-3xl">TEAM MEMBERS</h1>
                    </div>
                ...
                <MemberStuff
                    ...
                    desc2="Hello IclassNamem Praew! I'm a senior at Ruamrudee International School. I'm mainly in charge of the design and branding of the team, including templates for our website, team shirts, team logo, while also being in charge of our social media page. "
                    img2="https://static.igem.wiki/teams/4314/wiki/praew.jpg"
                />
                <MemberStuff
                    name1="Tun Ronnakorn Onraksa"
                    person1="Human Practices Leader, Group 1 Lab Member, Group 2 Lab Member"
                    desc1="Hi my name is Ada! I am currently a senior in Ruamrudee International School in Bangkok, Thailand. My responsibilities in the team include organizing and looking over the plans of the project as well as helping the team with any problems that may arise. I am forever grateful for my iGEM experience and all of my teammates. "
                    img1="https://static.igem.wiki/teams/4314/wiki/tun.jpg"
                    name2="Tara Phantharach Natnithikarat"
                    person2="Collaborations Member, Group 2 Lab Member"
                    desc2="Hi! My name is Tara and I'm a junior at RIS. I'm a Collaborations and group 2 lab member of Thailand_RIS. I enjoy listening to music and playing volleyball during my free time. I look forward to getting to meet all of you and learning about all the cool projects in Paris!"
                    img2="https://static.igem.wiki/teams/4314/wiki/tara.jpg"
                />
                <MemberStuff
                    name1="Elle Arachaporn Titapand "
                    person1="Human Practices Member, Group 2 Lab Leader"
                    desc1="Hi! I'm Elle, a junior at Ruamrudee International School. I am Groups 2's lab leader and a member of the human practices team. Preparing for the IGEM jamboree was a very great experience for me as I got to work with my friends and upperclassmen while gaining a deeper understanding of synthetic biology. I am very excited to learn about your insightful projects in Paris!"
                    img1="https://static.igem.wiki/teams/4314/wiki/elle.jpg"
                    ...
                    img2="https://static.igem.wiki/teams/4314/wiki/bhu.jpg"
                />
                <MemberStuff
                    name1="Jase Kemp"
                    person1="Wiki Coordinator, Collaborations Co-Leader"
                    desc1="Hey! My name is Jase, a current senior at Ruamrudee International School. I'm half American and half Chinese, some say the best of both the worlds. I enjoy being moderately active and having a good laugh with friends. Like Ada “I am forever grateful for my iGEM experience and all of my teammates.”"
                    img1="https://static.igem.wiki/teams/4314/wiki/jase.jpg"
                    name2="Team Tatpol Boonme"
                    person2="Human Practices Member, Group 1 Lab Leader"
                    desc2="Hello! My name is Team, and I am a senior at RIS. Throughout this project, I spent a majority of my time at the lab allowing me to garner tons of experience and knowledge. I'm very excited to showcase our work at the Jamboree and meet new faces!"
                    img2="https://static.igem.wiki/teams/4314/wiki/team.jpg"
                />
                <MemberStuff
                    ...
                    img1="https://static.igem.wiki/teams/4314/wiki/belle.jpg"
                    name2="Ivy Thitilapa Sae-Heng"
                    person2="Wiki Leader, Group 1 Lab Member"
                    desc2="Hello! I'm Ivy and I am currently a junior at Ruamrudee International School. I'm the Wiki Leader and a group 1 lab member of Thailand_RIS. I learned a lot about synthetic biology while doing the labs and also a lot about coding and technology while working on the wiki. I am looking forward to meeting new friends and attending the jamboree in Paris! "
                    img2="https://static.igem.wiki/teams/4314/wiki/ivy.jpg"
                />
                    ...
                    <div className="member-column">
                        ...
                        <div className="row1">
                            ...
                            <p className="member-text">
                                ...
                                alongside Thamognya to help realize the team's
                                creative wiki design by programming it on to a
                                NextJS application.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="member-column-right">
                        ...
                        <div className="row1">
                            <p className="member-text align-right">
                                ...
                                transform the team's ideas into tangible form.
                                Kaka and I utilized NextJS, TailwindCSS,
            ...
            <div className="members-narrow">
                ...
                <div className="body">
                    ...
                    />
                    <MemberStuffS
                        name1="Kaka Dhirath Thanglerdsumpan"
                        person1="Wiki Member"
                        desc1="Wassup! My name is Kaka, and I am a sophomore at Ruamrudee International School. I enjoy coding and anime, but I also like to touch grass. I worked alongside Thamognya to help realize the team&appos;s creative wiki design by programming it on to a NextJS application. "
                        img1="https://static.igem.wiki/teams/4314/wiki/kaka.jpg"
                        name2="Thamognya Kodi"
                        person2="Wiki Member"
                        desc2="Hey my name is Thamognya Kodi, and I am a sophomore at RIS. I like to code Machine Learning apps and watch anime. I helped transform the team&appos;s ideas into tangible form. Kaka and I utilized NextJS, TailwindCSS, ChakraUI, and Sass to help create the team&appos;s wiki."
                        img2="https://static.igem.wiki/teams/4314/wiki/thamognya.jpg"
                    />
                    <MemberStuffS
                        name1="Dr. Alisa Vangnai"
                        person1="Instructor"
